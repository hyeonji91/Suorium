    ...
    <div className="flex flex-col items-center justify-center w-full h-full">
      ...
      <form onSubmit={handleSubmit(loginHandler)} className="w-[310px]">
            ...
            render={({ field }) => (
              ...
              >
                <input
                  ...
                  onFocus={(e) =>
                    (e.currentTarget.parentElement!.style.borderColor = "#0091ea")
                  }
                  onBlur={(e) =>
                    (e.currentTarget.parentElement!.style.borderColor =
                      errors.email || emailError ? "#f87171" : "#d1d5db")
                  }
                />
                <label
                  htmlFor="email"
            ...
            render={({ field }) => (
              ...
              >
                <input
                  ...
                  onBlur={(e) =>
                    (e.currentTarget.parentElement!.style.borderColor =
                      errors.password || pwError ? "#f87171" : "#d1d5db")
                  }
                />
                <label
                  htmlFor="password"
        ...
        <button
          ...
          className="w-[310px] h-[48px] rounded-lg font-main font-bold text-lg text-white transition-colors duration-150 hover:brightness-90"
        >
          로그인
        </button>
      </form>
      <div className="flex flex-row mt-[20px]">
        ...
        <Link to="/signup">
          <p
            className="ml-1 font-semibold text-md font-main"
            style={{ color: "#0091ea" }}
          >
            회원가입 하기
          </p>
